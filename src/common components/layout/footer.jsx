        ...
        <div className="max-w-[110rem] mx-auto px-6 md:px-10 relative z-20 w-full flex-grow flex flex-col justify-center">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
            ...
            <div data-animate="fade-up" data-delay="100" className="lg:col-span-4 pr-0 lg:pr-12">
              ...
              {/* Follow Us */}
              <div className="mt-12">
                <h3 className="text-sm font-bold mb-6 text-brand-accent tracking-[0.2em] uppercase">Follow Us</h3>
                <div className="flex flex-wrap items-center gap-4">
                  <a href="https://www.facebook.com/share/1Enz1UJrBV/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:bg-brand-accent hover:text-white hover:border-brand-accent hover:-translate-y-1 transition-all duration-300 shadow-lg">
                  ...
                  <a href="https://www.linkedin.com/in/aayush-jain-1717a7213/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:bg-brand-accent hover:text-white hover:border-brand-accent hover:-translate-y-1 transition-all duration-300 shadow-lg">
                  ...
                  <a href="https://www.instagram.com/pdj_trade_connect/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:bg-brand-accent hover:text-white hover:border-brand-accent hover:-translate-y-1 transition-all duration-300 shadow-lg">
              ...
              <div className="flex flex-col gap-4 mb-8">
                ...
                <div className="flex items-center gap-4 group cursor-pointer">
                  <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 transition-colors group-hover:border-brand-accent/50 group-hover:bg-white/10">
                    <Phone className="w-4 h-4 text-white/70 group-hover:text-brand-accent transition-colors" />
                  </div>
                  <p className="text-white/80 font-medium tracking-wide group-hover:text-white transition-colors text-[15px]">+91-96874 74747</p>
                </div>
                ...
                <div className="flex items-start gap-4 group cursor-pointer">
                  <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 transition-colors group-hover:border-brand-accent/50 group-hover:bg-white/10 mt-0.5">
                    <MapPin className="w-4 h-4 text-white/70 group-hover:text-brand-accent transition-colors" />
                  </div>
                  <p className="text-white/80 font-medium leading-relaxed group-hover:text-white transition-colors text-sm">
                    Sector No - 12B, Plot No. 129,<br />Gandhidham, Kachchh,<br />Gujarat - 370201, India
                  </p>
                </div>
              </div>
            </div>
